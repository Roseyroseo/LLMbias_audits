export const EDUCATION_KEY_CONTENT = {
  ...
  implications: "Schools using these systems risk false accusations in academic integrity cases and biased personnel decisions for teachers. <br><br> Results changed across task framings, a model that looks fair in one setting may still behave poorly in another. <br><br> Schools should seriously reconsider deploying decision-making auxiliary tools without proper testing and human oversight, and set clear governance rules before attempting to use these tools in an official capacity.",
  limitation: "These experiments use controlled prompts and demographic proxies (embedded in the name) for gender and ethnicity rather than full classroom or HR workflows, so they show risk patterns rather than certify bias harm rates.",
  figureNote: "These visuals showcase how the same student or teacher profile can receive different scores after perturbing demographic cues. Significant score gaps could result in actionable harm for both students and teachers."
};
