export const EDUCATION_KEY_CONTENT = {
  ...
  implications: "Schools deploying these AI systems risk creating discriminatory academic integrity enforcement (falsely accusing certain students more often) and biased personnel decisions (systematically disadvantaging teachers with specific backgrounds). <br><br> The inconsistent behavior across task framings means pre-deployment testing in one scenario cannot guarantee fairness in real-world use. <br><br> Institutions must implement continuous demographic bias monitoring, provide human oversight for high-stakes decisions, and establish democratic governance processes before even considering deploying AI systems that affect students' and educators' futures.",
